...
describe('ChildProfile types', () => {
  ...
  describe('isChildProfile validation', () => {
    ...
    test('should reject invalid ChildProfile objects', () => {
      ...
      expect(isChildProfile({ id: 'profile-1', name: 'Test Child' })).toBe(false); // Missing entries
    ...
    test('should work with populated entries array', () => {
      const profileWithEntries = {
        ...
        name: 'Test Child',
        entries: [
          { id: 'entry-1', category: 'medical', title: 'Entry 1', description: 'Desc 1' },
          { id: 'entry-2', category: 'education', title: 'Entry 2', description: 'Desc 2' }
        ]
      };
