...
// Create sample entries for demo profile
    ...
    const loadInitialData = async () => {
      ...
      try {
        ...
        if ((window as any).__earlyShareData) {
          const { shareToken, encryptionKey } = (window as any)
            .__earlyShareData;
          ...
          if (shareMatch) {
            ...
            const onboardingCompleted =
              localStorage.getItem("manylla_onboarding_completed") === "true";
...
function App() {
  const [profileForSync, setProfileForSync] = useState<ChildProfile | null>(
    null,
  );
