...
interface UnifiedAddDialogProps {
  ...
  onAdd: (dataartial<QuickInfoConfig> | Partial<CategoryConfig>) => void;
  existingItems?uickInfoConfig[] | CategoryConfig[];
}
...
export const UnifiedAddDialog= ({
  ...
  const handleAdd = () => {
    if (mode === "quickInfo") {
      const displayName =
        selectedOption === "Custom..." ? customName electedOption;
    ...
    <Dialog open={open} onClose={handleClose} {...mobileDialogProps}>
      {isMobile ? (
        <AppBar position="sticky" color="default" elevation={0}>
          <Toolbar>
            <Typography variant="h6" sx={{ flexGrow }}>
          ...
          {mode === "quickInfo" ? (
            ...
            <Stack spacing={3}>
              ...
              <Box>
                ...
                <Box sx={{ display: "flex", gap: 8, flexWrap: "wrap", mb }}>
