...
describe('HighlightedText', () => {
  ...
  describe('Word boundary handling', () => {
    ...
    test('should handle punctuation around highlighted terms', () => {
      const content = 'Emergency! Call immediately. Important: check medication.';
      const { container } = render(<HighlightedText content={content} />);
  ...
  describe('Edge cases', () => {
    ...
    test('should handle very long content', () => {
      const longContent = 'This is a very long piece of text that contains many words including some that should be highlighted like emergency and medication and important terms that need to be visible to users immediately.';
    ...
    test('should handle content with newlines', () => {
      const content = 'Line 1: emergency\\nLine 2: medication\\nLine 3: important';
      const { container } = render(<HighlightedText content={content} />);
  ...
  describe('Component behavior', () => {
    ...
    test('should handle rapid prop changes', () => {
      const { rerender } = render(<HighlightedText content="Initial emergency text" />);
      expect(screen.getByText(/emergency/i)).toBeInTheDocument();
    ...
    test('should handle variant changes', () => {
      ...
      const { rerender } = render(<HighlightedText content={content} variant="body2" />);
      expect(screen.getByText(/emergency/i)).toBeInTheDocument();
    ...
    test('should handle highlight terms changes', () => {
      ...
      rerender(<HighlightedText content={content} highlightTerms={['custom']} />);
      expect(screen.getByText('custom')).toBeInTheDocument();

      rerender(<HighlightedText content={content} highlightTerms={['highlight']} />);
  ...
  describe('Accessibility and styling', () => {
    ...
    test('should handle complex text with multiple highlight patterns', () => {
      const content = 'Emergency: give medication immediately. Warning: check dose. Call doctor if allergic reaction occurs.';
      const { container } = render(<HighlightedText content={content} />);
