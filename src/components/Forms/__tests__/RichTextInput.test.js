...
describe("RichTextInput", () => {
  ...
  describe("User interactions", () => {
    ...
    test("should update when value prop changes", () => {
      const { rerender } = render(
        <RichTextInput {...defaultProps} value="Initial" />,
      );
  ...
  describe("Props combinations", () => {
    test("should handle all props together", () => {
      ...
      expect(
        screen.getByPlaceholderText("Complete Placeholder"),
      ).toBeInTheDocument();
  ...
  describe("Component state", () => {
    ...
    test("should handle onChange function changes", () => {
      ...
      const { rerender } = render(
        <RichTextInput {...defaultProps} onChange={onChange1} />,
      );
  ...
  describe("Accessibility", () => {
    ...
    test("should handle accessibility with helper text", () => {
      render(
        <RichTextInput {...defaultProps} helperText="Accessible helper" />,
      );
