...
jest.mock('react-native', () => ({
  ...
  Modal: ({ children, visible, transparent, animationType, statusBarTranslucent }) =>
    visible ? (
      <div
        data-testid="modal"
...
describe('LoadingOverlay', () => {
  ...
  describe('Component Structure', () => {
    ...
    it('should apply correct styling to components', () => {
      ...
      expect(message.style.color).toMatch(/(#FFFFFF|rgb\(255,\s*255,\s*255\)|white)/);
    });
  });
  ...
  describe('Open/Close Behavior', () => {
    ...
    it('should maintain message when toggling visibility', () => {
      ...
      const { rerender } = render(<LoadingOverlay open={false} message={customMessage} />);
  ...
  describe('Performance', () => {
    it('should render consistently with same props', () => {
      ...
      const { rerender } = render(<LoadingOverlay open={true} message={message} />);
