...
export const UnifiedModal = ({
  ...
  return (
    <Modal
      ...
      {...props}
    >
      <SafeAreaView style={[styles.modalContainer, { backgroundColor: colors.primary }]}>
        {Platform.OS !== 'web' && (
        ...
        <ScrollView 
          style={[styles.modalScrollView, { backgroundColor: colors.background.default }]}
        ...
        {/* Optional Footer */}
        {footer && (
          <View style={[styles.modalFooter, { backgroundColor: colors.background.default }]}>
            {footer}
          </View>
        )}
      </SafeAreaView>
