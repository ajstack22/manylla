...
export const SyncDialog = ({ open, onClose }) => {
                ...
                <View style={styles.statusRow}>
                  <View style={[
                    ...
                    <Text style={[
                      ...
                      syncStatus === "success" && styles.statusBadgeTextSuccess
                    ]}>
                      {syncStatus}
                    </Text>
                  </View>
            ...
            <View style={styles.cardHeader}>
              ...
              <View style={styles.cardContent}>
                ...
                <View style={styles.buttonRow}>
                  ...
                  >
                    <Text style={styles.primaryActionButtonText}>Create Invite Code</Text>
                  </TouchableOpacity>
                </View>
              </View>
            </View>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <View style={styles.menuOptionContent}>
            <Text style={styles.menuOptionTitle}>Enable Backup on This Device</Text>
      ...
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          ...
          <View style={styles.cardContent}>
            ...
            <Text style={styles.cardDescription}>
              This will create a secure sync group for your devices. You'll receive a recovery phrase to access your data from other devices.
            </Text>
          </View>
        </View>
      </View>
        ...
        <View style={styles.cardHeader}>
          ...
          <View style={styles.cardContent}>
            ...
            <View style={styles.stepsList}>
              <Text style={styles.stepItem}>1. Generate a unique recovery phrase</Text>
              <Text style={styles.stepItem}>2. Encrypt your data locally</Text>
              <Text style={styles.stepItem}>3. Create secure sync group</Text>
              <Text style={styles.stepItem}>4. Show recovery phrase (save it!)</Text>
            </View>
          </View>
        </View>
      </View>
    ...
    <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.inputGroup}>
        ...
        <Text style={styles.helperText}>
          Enter an 8-character invite code (XXXX-XXXX) or 32-character backup code
        </Text>
      </View>
      ...
      <View style={styles.actions}>
        ...
        <TouchableOpacity
          style={[styles.button, styles.primaryButton, !joinPhrase.trim() && styles.buttonDisabled]}
  ...
  const renderPhraseStep = () => (
    <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
      ...
      <Text style={styles.instructions}>
        Save this recovery phrase in a secure location. You'll need it to access your data from other devices.
      </Text>
      ...
      <View style={styles.warningAlert}>
        ...
        <Text style={styles.warningAlertText}>
          This phrase is the only way to access your synced data. Store it securely and never share it with anyone.
        </Text>
      </View>
  ...
  const renderInviteStep = () => (
    <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
      <View style={styles.successAlert}>
        <Text style={styles.successIcon}>✓</Text>
        <Text style={styles.successText}>Invite code created successfully!</Text>
      </View>
