      ...
      return (
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
          <View style={styles.successAlert}>
            <Text style={styles.successAlertText}>✓ Multi-device sync is enabled</Text>
          </View>
          
          <View style={styles.card}>
            <Text style={styles.cardTitle}>Sync Status</Text>
            <Text style={styles.cardDescription}>Your data is synchronized across devices</Text>
            <View style={styles.statusRow}>
              <View style={[styles.chip, syncStatus === 'success' && styles.chipSuccess]}>
    ...
    switch (mode) {
          ...
          <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
            ...
            >
              ...
              <View style={styles.menuCardContent}>
                <Text style={styles.menuCardTitle}>Enable Backup on This Device</Text>
                <Text style={styles.menuCardDescription}>Create a new backup for your devices</Text>
              </View>
            </TouchableOpacity>
          ...
          <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
            ...
            <View style={[styles.card, styles.infoCard]}>
              ...
              <View style={styles.orderedList}>
                <Text style={styles.listItem}>1. Generate a unique recovery phrase</Text>
                <Text style={styles.listItem}>2. Encrypt your data locally</Text>
                <Text style={styles.listItem}>3. Create secure sync group</Text>
                <Text style={styles.listItem}>4. Show recovery phrase (save it!)</Text>
              </View>
            </View>
      ...
      case 'phrase':
        return (
          <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
            <View style={styles.successAlert}>
              <Text style={styles.successAlertText}>✓ Sync enabled successfully!</Text>
            </View>
            ...
            <View style={styles.warningAlert}>
              ...
              <Text style={styles.warningAlertText}>
                This phrase is the only way to access your synced data. 
      ...
      case 'invite':
        return (
          <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
            <View style={styles.successAlert}>
              <Text style={styles.successAlertText}>✓ Invite code created successfully!</Text>
            </View>
