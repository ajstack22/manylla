              ...
              <Box sx={{ display: "flex", alignItems: "flex-start", gap: 2 }}>
                ...
                <Box sx={{ flex: 1 }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    ...
                    You'll receive a recovery phrase to access your data from
                    other devices.
                  </Typography>
                </Box>
              </Box>
        ...
        return (
          <>
            ...
            <Alert severity="warning">
              <Typography variant="caption">
                <strong>Important:</strong> This phrase is the only way to
                access your synced data. Store it securely and never share it
                with anyone.
              </Typography>
            </Alert>
