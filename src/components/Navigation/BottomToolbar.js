...
const BottomToolbar = ({
  ...
  const MenuButton = ({ item, compact = false }) => {
    ...
    return (
      ...
      >
        <Icon size={compact || !isDesktop ? 20 : 22} color={itemColor} />
        <Text
          style={[
            styles.menuLabel,
            { color: itemColor },
              ...
              >
                ...
                <Text
                  style={[
                    ...
                    {
                      color:
                        colors.text?.primary || colors.primary || "#A08670",
                    },
                  ]}
                >
                  More
            ...
            {overflowItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <Text
                    style={[styles.overflowMenuLabel, { color: itemColor }]}
                  >
                    {item.label}
                  </Text>
                </TouchableOpacity>
              ...
              >
                <PaletteIcon
                  ...
                  color={
                    theme === "dark"
                      ? "#FFFFFF"
                      : colors.text?.primary || colors.primary || "#333"
                  }
                />
                <Text
                  style={[
...
const createStyles = (colors, bottomPadding) =>
  StyleSheet.create({
    container: {
      position: "fixed",
      bottom: 0,
