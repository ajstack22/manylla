            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Box sx={{ pl: 2 }}>
                <Typography variant="body2" paragraph>
                  <strong>Communication:</strong> Uses 2-3 word phrases.
                  Understands more than she can express.
                </Typography>
                <Typography variant="body2" paragraph>
                  <strong>Sensory:</strong> Sensitive to loud noises and bright
                  lights. Loves soft textures.
                </Typography>
                <Typography variant="body2" paragraph>
                  <strong>Medical:</strong> No allergies. Takes melatonin for
                  sleep (prescribed).
                </Typography>
                <Typography variant="body2" paragraph>
                  <strong>Dietary:</strong> Gluten-free diet. Prefers crunchy
                  foods. No nuts.
                </Typography>
                <Typography variant="body2" paragraph>
                  <strong>Emergency Contact:</strong> Mom: 555-0123, Dad:
                  555-0124
                </Typography>
              </Box>
            </Box>
