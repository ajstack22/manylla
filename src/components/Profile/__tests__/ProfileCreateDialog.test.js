...
jest.doMock('react-native', () => ({
  ...
  Text: ({ children, style, ...props }) => <span style={style} {...props}>{children}</span>,
  ...
  ScrollView: ({ children, style, ...props }) => <div style={style} {...props}>{children}</div>,
  SafeAreaView: ({ children, style, ...props }) => <div style={style} {...props}>{children}</div>,
  Image: ({ source, style, ...props }) => <img src={source?.uri || source} style={style} {...props} />,
  StyleSheet: {
...
describe('ProfileCreateDialog', () => {
  ...
  describe('Basic Info Step', () => {
    ...
    it('handles preferred name input changes', () => {
      ...
      const preferredNameInput = screen.getByPlaceholderText('What they like to be called');
  ...
  describe('Photo Step', () => {
    ...
    it('renders photo step correctly', () => {
      expect(screen.getByText('Add a photo to personalize the profile (optional)')).toBeInTheDocument();
