...
interface SyncContextType {
  ...
  ) => Promise<{ recoveryPhrase: string; syncId: string }>;
...
export const SyncProvider: React.FC<SyncProviderProps> = ({
  ...
  const [syncStatus, setSyncStatus] = useState<
    "idle" | "syncing" | "error" | "success" | "not-setup"
  >("not-setup");
  ...
  const enableSync = async (
    ...
    try {
      ...
      const phrase =
        existingPhrase || manyllaMinimalSyncService.generateRecoveryPhrase();
