...
describe('inviteCode utilities', () => {
  ...
  describe('generateInviteUrl', () => {
    it('should generate correct URL format', () => {
      ...
      const url = generateInviteUrl(inviteCode, recoveryPhrase, 'https://manylla.com');

      expect(url).toBe('https://manylla.com/sync/ABCD-2345#test-recovery-phrase');
    });
    ...
    it('should handle special characters in recovery phrase', () => {
      ...
      expect(url).toBe('https://manylla.com/sync/XYZA-9876#phrase-with-special-chars_123');
    });
  ...
  describe('storeInviteCode', () => {
    it('should store invite code data', () => {
      ...
      expect(storedData[inviteCode].expiresAt).toBeGreaterThan(storedData[inviteCode].createdAt);
    });
  ...
  describe('edge cases and security', () => {
    ...
    it('should handle storage quota exceeded', () => {
      ...
      expect(() => storeInviteCode('TEST-1234', 'sync', 'phrase')).not.toThrow();
    });
