...
describe('ProfileValidator - Comprehensive Tests', () => {
  describe('validateProfile', () => {
    ...
    test('should validate date of birth', () => {
      ...
      const futureDateProfile = { ...baseProfile, dateOfBirth: futureDate.toISOString() };
  ...
  describe('sanitizeInput', () => {
    test('should sanitize HTML and script tags', () => {
      const maliciousInput = '<script>alert("XSS")</script>Normal text<img src=x onerror=alert(1)>';
