 ...
 */
export function generateInviteUrl(inviteCode: string, recoveryPhrase: string): string {
 ...
 */
export function parseInviteUrl(pathname: string, hash: string): {
 ...
 */
export function storeInviteCode(inviteCode: string, syncId: string, recoveryPhrase: string): void {
