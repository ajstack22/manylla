...
export function getVisibleQuickInfo(panels: QuickInfoConfig[]): QuickInfoConfig[] {
  return panels
    .filter(panel => panel.isVisible)
    .sort((a, b) => a.order - b.order);
}

export function getQuickInfoByName(panels: QuickInfoConfig[], name: string): QuickInfoConfig | undefined {
