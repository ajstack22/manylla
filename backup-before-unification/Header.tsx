...
export const Header: React.FC<HeaderProps> = ({
  ...
  // Make toast optional - App.js doesn't provide ToastProvider
  let showInfo: ((message: string) => void) | undefined;
  try {
    const toast = useToast();
    showInfo = toast.showInfo;
  } catch {
    // If no ToastProvider, just log to console
    showInfo = (message: string) => console.log(`[Theme Toggle] ${message}`);
  }
